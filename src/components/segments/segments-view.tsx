...
import { excluirSegmentoAction } from "@/app/(crm)/segmentos/actions";
...
import type { SegmentRuleOptions } from "@/components/segments/rule-value-field";
...
export function SegmentsView({
  ...
  function remover(id: string) {
    startTransition(async () => {
      await excluirSegmentoAction(id);
      router.refresh();
    });
  }
